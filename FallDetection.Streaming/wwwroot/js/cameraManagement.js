...
const CameraManagement = {
    async showPopup() {
        try {
            ...
            NotificationSystem.show('Failed to load camera list', 'error');
        }
    },

    forgetCamera(cameraId) {
        UIControls.showConfirm('Forget Camera', `Are you sure you want to forget camera ${cameraId}? This cannot be undone.`, async () => {
            try {
                ...
                if (response.ok) {
                    NotificationSystem.show(`✅ Camera ${cameraId} has been forgotten.`, 'success');
                    ...
                    NotificationSystem.show('❌ Failed to forget camera.', 'error');
                }
            } catch (error) {
                console.error('Forget camera error:', error);
                NotificationSystem.show('❌ Error forgetting camera.', 'error');
            }
        });
    },
